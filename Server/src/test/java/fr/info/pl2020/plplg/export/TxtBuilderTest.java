...
public class TxtBuilderTest {
    @Test
    void addCareerTest() throws IOException {
        ...
        assertEquals(txtBuilder.getContent().toString(), "");

        txtBuilder = txtBuilder.addCareer(ca);
        assertNotEquals(txtBuilder.getContent().toString(), "");

        assertNotNull(txtBuilder);
    }
